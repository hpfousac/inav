...
PG_RESET_TEMPLATE(mixerConfig_t, mixerConfig,
    .mixerMode = MIXER_CUSTOM_AIRPLANE,
...
static const mixer_t mixerTable[] = {
    DEF_MIXER( MIXER_FLYING_WING,       0,   2,          true,       false,      mixerDualProp ),
    DEF_MIXER( MIXER_AIRPLANE,          0,   2,          true,       true,       mixerDualProp ),
    DEF_MIXER( MIXER_CUSTOM_AIRPLANE,   0,   2,          true,       true,       NULL ),
};
