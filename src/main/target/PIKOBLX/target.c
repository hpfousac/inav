...
const timerHardware_t timerHardware[] = {
    { TIM3,  IO_TAG(PA4),  TIM_Channel_2, 1, IOCFG_AF_PP,    GPIO_AF_2,                       TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM1  - PA4  - *TIM3_CH2
    { TIM3,  IO_TAG(PA6),  TIM_Channel_1, 1, IOCFG_AF_PP,    GPIO_AF_2,                       TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM2  - PA6  - *TIM3_CH1, TIM8_BKIN, TIM1_BKIN, TIM16_CH1
