...
const timerHardware_t timerHardware[] = {
    ...
    { TIM4, IO_TAG(PB8),  TIM_Channel_3, 1, IOCFG_AF_PP, GPIO_AF_TIM4, TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM6  - PB8  OUT1
    { TIM4, IO_TAG(PB9),  TIM_Channel_4, 1, IOCFG_AF_PP, GPIO_AF_TIM4, TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM7  - PB9  OUT2
