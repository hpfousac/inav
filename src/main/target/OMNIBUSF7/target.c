...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH3, PB0,   TIM_USE_FW_MOTOR,         0, 0 ), // M1
    DEF_TIM(TIM3, CH4, PB1,   TIM_USE_FW_MOTOR,         0, 0 ), // M2
    DEF_TIM(TIM1, CH1, PE9,   TIM_USE_FW_SERVO,         0, 2 ), // M3
    DEF_TIM(TIM1, CH2, PE11,  TIM_USE_FW_SERVO,         0, 1 ), // M4
