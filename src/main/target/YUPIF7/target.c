...
const timerHardware_t timerHardware[] = {
    ...
    { TIM2,  IO_TAG(PA0),  TIM_CHANNEL_1, 1, IOCFG_AF_PP_PD, GPIO_AF1_TIM2, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, 					// S1_OUT
    { TIM5,  IO_TAG(PA1),  TIM_CHANNEL_2, 1, IOCFG_AF_PP_PD, GPIO_AF2_TIM5, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, 					// S2_OUT
