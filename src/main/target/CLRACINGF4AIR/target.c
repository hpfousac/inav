...
#else
    { TIM3,  IO_TAG(PB0),    TIM_Channel_3, 1,  IOCFG_AF_PP, GPIO_AF_TIM3,   TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },      // MOTOR_1
    { TIM3,  IO_TAG(PB1),    TIM_Channel_4, 1,  IOCFG_AF_PP, GPIO_AF_TIM3,   TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },      // MOTOR_2
