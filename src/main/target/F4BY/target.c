...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM2, CH1, PA0,   TIM_USE_FW_MOTOR, 0, 0), // S1_OUT
    DEF_TIM(TIM2, CH2, PA1,   TIM_USE_FW_MOTOR, 0, 0), // S2_OUT
    DEF_TIM(TIM5, CH3, PA2,   TIM_USE_FW_SERVO, 0, 0), // S3_OUT
    DEF_TIM(TIM5, CH4, PA3,   TIM_USE_FW_SERVO, 0, 0), // S4_OUT
    DEF_TIM(TIM1, CH1, PE9,   TIM_USE_FW_SERVO, 0, 0), // S5_OUT
    DEF_TIM(TIM1, CH2, PE11,  TIM_USE_FW_SERVO, 0, 0), // S6_OUT
    DEF_TIM(TIM1, CH3, PE13,  TIM_USE_FW_SERVO, 0, 0), // S7_OUT
    DEF_TIM(TIM1, CH4, PE14,  TIM_USE_FW_SERVO, 0, 0), // S8_OUT
