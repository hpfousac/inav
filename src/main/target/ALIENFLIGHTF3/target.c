...
const timerHardware_t timerHardware[] = {
    ...
    { TIM15, IO_TAG(PB15), TIM_Channel_2, 1, IOCFG_AF_PP, GPIO_AF_1,    TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM1  - PB15 - TIM1_CH3N, TIM15_CH1N, *TIM15_CH2
    { TIM15, IO_TAG(PB14), TIM_Channel_1, 1, IOCFG_AF_PP, GPIO_AF_1,    TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM2  - PB14 - TIM1_CH2N, *TIM15_CH1
