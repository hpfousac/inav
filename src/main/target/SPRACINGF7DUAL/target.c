...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8,  CH2, PC7,  0,               0, 0), // ESC 1
#else
    DEF_TIM(TIM8,  CH3, PC8,  0,               0, 0), // ESC 1
#endif
    DEF_TIM(TIM8,  CH1, PC6,  0,               0, 0), // ESC 2
    DEF_TIM(TIM8,  CH4, PC9,  0,               0, 0), // ESC 3
#if (SPRACINGF7DUAL_REV <= 1)
    DEF_TIM(TIM8,  CH3, PC8,  0,               0, 0), // ESC 4
#else
    DEF_TIM(TIM8,  CH2, PC7,  0,               0, 0), // ESC 4
#endif

    DEF_TIM(TIM4,  CH1, PB6,  0,               0, 0), // ESC 5 / Conflicts with USART5_RX / SPI3_RX - SPI3_RX can be mapped to DMA1_ST3_CH0
    DEF_TIM(TIM4,  CH2, PB7,  0,               0, 0), // ESC 6 / Conflicts with USART3_RX
    DEF_TIM(TIM3,  CH4, PB1,  0,               0, 0), // ESC 7
    DEF_TIM(TIM3,  CH3, PB0,  0,               0, 0), // ESC 8
    ...
    DEF_TIM(TIM2,  CH3, PB10, 0,               0, 0), // Shared with UART3 TX PIN and SPI3 TX (OSD)
    DEF_TIM(TIM2,  CH4, PB11, 0,               0, 0), // Shared with UART3 RX PIN
