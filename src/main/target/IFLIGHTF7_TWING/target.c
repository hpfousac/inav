...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8, CH3, PC8,  TIM_USE_FW_SERVO, 0, 0),
    DEF_TIM(TIM8, CH1, PC6,  TIM_USE_FW_SERVO, 0, 0),
    DEF_TIM(TIM8, CH4, PC9,  TIM_USE_FW_SERVO, 0, 0),
    DEF_TIM(TIM8, CH2, PC7,  TIM_USE_FW_SERVO, 0, 0),

    DEF_TIM(TIM4, CH1, PB6,  TIM_USE_FW_MOTOR, 0, 0),
    DEF_TIM(TIM4, CH2, PB7,  TIM_USE_FW_MOTOR, 0, 0), 
