...
const timerHardware_t timerHardware[] = {
    ...
    { TIM4, IO_TAG(PD13), TIM_Channel_2, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM4, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },  // S5_OUT
    { TIM4, IO_TAG(PD14), TIM_Channel_3, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM4, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },  // S6_OUT
};
