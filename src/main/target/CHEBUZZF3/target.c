...
const timerHardware_t timerHardware[] = {
    ...
    { TIM4,  IO_TAG(PD12), TIM_Channel_1, 0, IOCFG_AF_PP,    GPIO_AF_2, TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM9 - PD12
    { TIM4,  IO_TAG(PD13), TIM_Channel_2, 0, IOCFG_AF_PP,    GPIO_AF_2, TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR }, // PWM10 - PD13
