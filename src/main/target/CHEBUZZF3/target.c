...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH1, PD12,  TIM_USE_FW_MOTOR,   0), // PWM9 - PD12
    DEF_TIM(TIM4,  CH2, PD13,  TIM_USE_FW_MOTOR,   0), // PWM10 - PD13
    DEF_TIM(TIM4,  CH3, PD14,  TIM_USE_FW_SERVO,   0), // PWM11 - PD14
    DEF_TIM(TIM4,  CH4, PD15,  TIM_USE_FW_SERVO,   0), // PWM12 - PD15
    DEF_TIM(TIM2,  CH2, PA1,   TIM_USE_FW_SERVO,   0), // PWM13 - PA1
    DEF_TIM(TIM2,  CH3, PA2,   TIM_USE_FW_SERVO,   0), // PWM14 - PA2
