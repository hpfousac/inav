...
const timerHardware_t timerHardware[] = {
    { TIM4, IO_TAG(PB7),    TIM_Channel_2, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM4,  TIM_USE_MC_MOTOR  | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },  //S1
    { TIM4, IO_TAG(PB6),    TIM_Channel_1, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM4,  TIM_USE_MC_MOTOR  | TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },  //S2
