...
const timerHardware_t timerHardware[] = {
    ...
    { TIM12, IO_TAG(PB14), TIM_Channel_1, 1, IOCFG_AF_PP, GPIO_AF_TIM12,    TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },// S1_OUT
    { TIM12, IO_TAG(PB15), TIM_Channel_2, 1, IOCFG_AF_PP, GPIO_AF_TIM12,    TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO | TIM_USE_FW_MOTOR },// S2_OUT
